<?php
    ...
    if($result->num_rows > 0){
        $row = $result->fetch_assoc(); // 회원 정보
        
        # 로그인 유저가 탈퇴한 회원이라면 USER_STATE = 1
        if($row['USER_STATE'] == 1){
            echo "<script>alert('탈퇴한 계정입니다.\\r\\n로그인할 수 없습니다.');location.href = '/main.php';</script>";
        ...
        # 로그인 처리
            ...
            // 쿠키 삭제
                ...
                setcookie("JENI_USER_ID", '', time() - 60, "/");
            }
